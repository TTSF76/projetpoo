...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->gbxMain->Text = L"Supprimer un personnel";
			// 
			// button2
			// 
			...
			this->label1->Text = L"Personnel à supprimer";
			// 
			// cbxPersonel
			// 
			this->cbxPersonel->FormattingEnabled = true;
			this->cbxPersonel->Location = System::Drawing::Point(169, 45);
			this->cbxPersonel->Name = L"cbxPersonel";
			this->cbxPersonel->Size = System::Drawing::Size(202, 24);
			...
			this->ClientSize = System::Drawing::Size(421, 139);
			this->Controls->Add(this->gbxMain);
			this->Name = L"InputPersonnelSupprimer";
			this->Text = L"InputPersonnelSupprimer";
